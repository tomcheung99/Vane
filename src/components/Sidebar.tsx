...
const Sidebar = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div>
      ...
      <div className="fixed bottom-0 inset-x-0 z-50 flex flex-row items-center gap-x-6 bg-light-secondary dark:bg-dark-secondary px-4 pt-4 pb-[calc(env(safe-area-inset-bottom)+1rem)] shadow-sm lg:hidden">
        {navLinks.map((link, i) => (
          <Link
            href={link.href}
            key={i}
