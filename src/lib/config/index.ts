...
class ConfigManager {
  ...
  uiConfigSections: UIConfigSections = {
    preferences: [
      ...
      {
        name: 'Reranker API URL',
        key: 'retrievalApiUrl',
        type: 'string',
        required: false,
        description: 'Base URL of an external reranker API (e.g. https://api.jina.ai). The /v1/rerank endpoint will be called. Leave empty to use the local ONNX reranker.',
        placeholder: 'https://api.jina.ai',
        default: '',
        scope: 'server',
        env: 'RETRIEVAL_API_URL',
      },
      {
        ...
        type: 'password',
        required: false,
        description: 'API key for the external reranker API (e.g. Jina API key).',
        placeholder: 'jina_xxxx or Bearer token',
        default: '',
        scope: 'server',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: 'Model name for the external reranker API (e.g. jina-reranker-v3).',
        placeholder: 'jina-reranker-v2-base-multilingual',
        default: 'jina-reranker-v2-base-multilingual',
        scope: 'server',
      },
      {
        name: 'ColBERT Pre-Reranking',
        key: 'colbertEnabled',
        type: 'switch',
        required: false,
        description: 'Enable ColBERT fine-grained vector matching as a pre-filtering step before Cross-Encoder reranking. Requires External Retrieval API.',
        default: false,
        scope: 'server',
      },
    ],
